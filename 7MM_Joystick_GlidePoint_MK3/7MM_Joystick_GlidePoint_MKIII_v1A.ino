// 7MM_Joystick_GlidePoint_MKIII_v1A
// 2023-05-19-A
...
// 2023-05-19 : For the MKIII, removed unnecessary code
...
const int minHorz=220; 
const int maxHorz=1220; 
const int minVert=120;
const int maxVert=1500;
...
void loop() {
  ...
  {    
    ...
    //MKIII has the alignment changed. Now 90 degree flipped/rotated -- when viewed from face
